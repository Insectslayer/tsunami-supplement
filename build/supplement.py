...
def prepare_quantitative_markdown(markdown: str) -> str:
    ...
    web_omissions = {
        analysis_item,
        requirements_item,
        "- `TSUNAMI_quantitative_figures.ipynb` — one-off descriptive-figure export notebook.",
        "- `figures/` — SVG figures generated by the figure-export notebook and used by the web supplement.",
        "- `input/` — 14 anonymized, analysis-ready CSV files.",
    }
    markdown = "\n".join(
        line for line in markdown.splitlines() if line not in web_omissions
    )
